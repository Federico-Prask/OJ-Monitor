...
namespace OJMonitor.API.Controllers
{
    ...
    public class PlatformsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<object>>> GetPlatforms()
        {
        ...
        public async Task<ActionResult<object>> GetUserStats(string platformId, string username)
        {
            try
            {
        ...
        public async Task<ActionResult<List<object>>> GetRecentSubmissions(
